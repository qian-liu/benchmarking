...
The recognition accuracy reaches the highest when 50 patterns are trained per digit.
Because of \textbf{lower precision on membrane potential and synaptic weights}, the accuracies differ in the range of $\pm0.5\%$.
...
Even with the smallest network, SpiNNaker wins in the energy cost comparison.

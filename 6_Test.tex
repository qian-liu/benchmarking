...
On the other hand, SpiNNaker works in real (biology real) time and the simulation time becomes shorter than NEST simulation when $1,000$ patterns per digit are used.

...
\def\Authors{Qian~Liu\,$^{1,*}$, Garibaldi~Pinedagarcia\,$^{1}$ ,Evangelos~Stromatias\,$^{1}$, Teresa~Gotarredona\,$^{2}$, and Steve~Furber\,$^{1}$}
...
\input{2_Guide.tex}
\input{3_Database.tex}
\input{4_Evaluate.tex}
\input{5_Test.tex}

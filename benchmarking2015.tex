...
The data will be in Address-Event Representation (AER) format which is widely used in neuromorphic engineering field unlike conventional images.
...
%Additionally, building SNN models based on the dataset will ease benchmarking such models on various neuromorphic hardware platforms.

\section{The Database: MNIST-NM15}
\label{sec:data}
...
\subsection{Data Description}	
  ...
  \input{4-2-2_Rank-ordered_encoding}
	...
	\begin{figure}[b!]
	  \centering
	  \subfloat[Spike count of a Poissonian spike train]{
	    \label{fig:poisson_count}
	    \includegraphics[width=0.48\textwidth]{poisson_count.pdf}
	  }
	  \\
	  \subfloat[Spike count of a DVS recording of a flashing digit]{
	  	\label{fig:flash_count}
	  	\includegraphics[width=0.48\textwidth]{count.pdf}
	  }

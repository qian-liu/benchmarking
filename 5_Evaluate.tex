...
%contents
      ...
      \begin{mycell}{1.9cm} None \end{mycell}& % preprocessing 
      \begin{mycell}{3.5cm} k-means clustering, \\ FC decision layer, \\ LIF neurons \end{mycell}& % network
      \begin{mycell}{3.5cm} Supervised \end{mycell}& % training
      \begin{mycell}{3.5cm} 90\% \end{mycell}\\ % recognition
    \end{tabular}
    \egroup
  \end{center}

...
%        Sim. time [0.5$s$, 5$s$] 
      ...
      \begin{mycell}{3.5cm} 96.5\% 
%      	\\ (2.2\% non-class, \\1.3\% wrong-class)
      	\end{mycell} \\% recognition
      %
      ...
      \begin{mycell}{3.5cm} Off-line training,\\ unsupervised \end{mycell}&  % training
...
%       \begin{minipage}{1.7cm}\centering Programming front-end \end{minipage}  
       ...
       \begin{mycell}{2.0cm}11- to 14-bit synapses \\ Programmable
       \end{mycell} & 
       ...
       \begin{mycell}{2.0cm}122 bits
%       	 per neuron \\(parameters + state)
       	 \\ $\sim$4-bit synapse 

...
%contents
      ...
      \begin{mycell}{3.5cm} 99.1\% (ConvNet), \\ 98.6\% (FCnet);\\Biological time\end{mycell}\\ % recognition
      %
...
%      \begin{mycell}{3.5cm} 96.5\% \\ (2.2\% non-class, \\1.3\% wrong-class)\end{mycell} \\% recognition
      ...
      \begin{mycell}{3.5cm} Semi-supervised, STDP, \\ calcium LTP/LTD \end{mycell} &  % training
      \begin{mycell}{3.5cm} 91.6\% \\ 300~ms latency \end{mycell} \\% recognition
      ...
      \begin{mycell}{1.9cm} Threshold or DVS \end{mycell}& % preprocessing 
      ...
      \begin{mycell}{3.5cm} 91.3\% (threshold) \\ 11~s latency \\ 88.1\% (DVS) \\ 2 s latency\end{mycell}\\ % recognition
      %
...
%       \begin{minipage}{1.7cm}\centering Programming front-end \end{minipage}  
       ...
       \begin{mycell}{2.0cm}Fixed,\\Configurable,\\Axonal delay,\\256 syn/neuron\end{mycell}& 
...
%       	 \\ (4 signed integer choices + on/off state)
       ...
       \begin{mycell}{2.0cm}Fixed,\\Configurable,\\Shared synapse\end{mycell} & 
       ...
       \begin{mycell}{2.0cm}Fixed,\\Configurable\\224 syn/neuron\end{mycell}& 
       \begin{mycell}{2.0cm}Fixed rule\end{mycell}& 
       ...
       \begin{mycell}{2.0cm}Mixed-mode,\\Scalable\end{mycell} &
       \begin{mycell}{2.0cm}Fixed,\\Shared \\configuration\end{mycell}& 
       \begin{mycell}{2.0cm}No plasticity\end{mycell} &  

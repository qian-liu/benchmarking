...
Achieving the brain's energy efficiency motivates the development of neuromorphic hardware, since the brain consumes only about 20~W of power~\citep{drubach2000brain}.
...
%	Other spike representation schemes may do a better job of preserving information from the original stimuli.
	...
	In order to reveal the advantages of neuromorphic engineering: highly 	accurate, rapid, energy-efficient recognition, we need not only a spike-based dataset but also an appropriate evaluation methodology.

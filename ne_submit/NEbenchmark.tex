...
\begin{table*}[hbt!]
	...
	\begin{center}
		...
		\begin{tabular}{ l c c c c }
			...
			\begin{mycell}{3.5cm} 92.99\%\\1~s per test\\13.82~ms latency\\$5.01$M Sopbs\end{mycell}\\ % recognition
		\end{tabular}
		\egroup
	\end{center}
...
\begin{table*}[hbt!]
	...
	\begin{center}
		...
		\begin{tabular}{ l l l l }
			...
			\begin{leftcell}{4.5cm} - \textbf{classification accuracy}\\ - \textbf{\textit{response latency}}\\ - \textbf{\textit{number of events}} \\ - \textit{biological testing time}\\ - \textit{input spiking rate}  \end{leftcell}% recognition
		\end{tabular}
		\egroup
	\end{center}
	\label{tb:model_eval}

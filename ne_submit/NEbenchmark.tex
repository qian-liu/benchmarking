      ...
      \begin{minipage}{\textwidth}
        ...
        \begin{savenotes}
          ...
          \footnote[1]{We consider them 4-bit synapses because it is only possible to choose between 4 different signed integers and whether the synapse is active or not.}
  			...
  			\begin{mycell}{2.0cm}46 GSops/W \\ 26 pJ/SE \end{mycell} \\
  			...
  			\begin{mycell}{2.0cm}Real-time\end{mycell} &
  			\begin{mycell}{2.0cm}941 pJ/SE \\ 1 GSops/W\end{mycell} \\
  			%
        ...
        \end{mycell}&
  			...
  			Real-time&
  			\begin{mycell}{2.0cm}22-pJ/SE 45.5GSops/W\\\citep{park201465k}\\50pJ/SE 20GSops/W\end{mycell}

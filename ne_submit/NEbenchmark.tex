...
In addition, implementations on neuromorhpic hardware have enabled large-scale networks to run in (or even faster than) real-time, and made it accessible on mobile robots.
...
Python code for converting from one file format to the other and vice versa.

...
\label{sec:eval}
Due to the spike-based processing of SNN models, there are new concerns of performance evaluation on network models other than recognition accuracy.
Once implemented on neuromorphic platforms, the hardware performance can be evaluated by running the same models.
This model-specific assessment provides a more robust comparison on the feasibility, flexibility, simulation time and energy cost of hardware platforms.

...
While software modelling provides great flexibility, digital platforms have reduced precision (due to the inherent discretization) and higher energy consumption, when compared to analogue platforms.
...
Thus the weak weights were set to inhibitory connections with identical strengths in testing.
The negative connections reduced the output firing rates and enlarged the disparities over digits.

...
\begin{table*}[hbt!]
	...
	\begin{center}
		...
		\begin{tabular}{ l l l l }
			\begin{mycell}{3.7cm}Transformations\end{mycell} & 
...
Running an identical SNN model on different neuromorphic hardware platforms can not only expose whether any of the previously mentioned capacities are supported, but also benchmark their performance on simulation time and energy usage.

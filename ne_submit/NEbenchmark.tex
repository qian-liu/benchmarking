...
Results has that inhibitory synapses reduced the output firing rates while keeping a good classification ability.
Thus the strategy of replacing weak weights to same negative values was used throughout the paper.
...
In doing so, the power consumption is better approximated by just measuring the resources needed to run the simulation.

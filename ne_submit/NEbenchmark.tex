...
\begin{figure}[hbt!]
	...
	\caption{Power dissipation and energy per synaptic event of a spiking DBN running on a single SpiNNaker chip as a function of the total input firing rate \citep{Stromatias2015scalable}.}

...
Using one spike per neuron, similar to the first spiking wave in biology,~\cite{delorme2001face} reported 100\% and 97.5\% accuracies on the face identification task over training (40 individuals $\times$ 8 images) and testing data (40 individuals $\times$ 2 images).
...
%				$3,000,000$~s of training\\ 
			...
			\begin{mycell}{3.5cm} 92.99\%\\1~s per test\\0.2~s blank \\13.82~ms latency\\$4.17$M Sopbs\end{mycell}\\ % recognition
		\end{tabular}
		\egroup
	\end{center}
